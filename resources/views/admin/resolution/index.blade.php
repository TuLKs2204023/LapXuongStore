...
@section('contents')
    <!-- Start Page Title -->
    <div class="pagetitle">
        <h1>Screen Resolution Management</h1>
        <nav style="--bs-breadcrumb-divider: '>';">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ Route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Screen Resolution</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        ...
        @if (auth()->user()->role !== 'Customer')
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="resolutionsMgmt" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
@section('myJs')
    <script>
        $(function() {
            $("#resolutionsMgmt").DataTable({
                "responsive": true,
                "lengthChange": true,
                "autoWidth": true,
                "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
            }).buttons().container().appendTo('#resolutionsMgmt_wrapper .col-md-6:eq(0)');
        });
    </script>
@endsection
