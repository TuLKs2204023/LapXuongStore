    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-primary" href="{{ Route('admin.series.create') }}">
                        ...
                        @foreach ($series as $item)
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    ...
                                    href="{{ Route('series.details', $item->slug) }}">
                                    <i class="fas fa-folder">
                                    </i>
                                    View
                                </a> --}}
                                    <a class="btn btn-outline-info btn-sm" href="{{ Route('admin.series.edit', $item->id) }}">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>
                                    <form action="{{ Route('admin.series.destroy') }}" method="post"
