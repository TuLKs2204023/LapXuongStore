                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" value="{{ $edit->name }}"
                                    required placeholder="Please enter User name">
                            </div>
                        </div> <!-- / Name Section -->
                        <!-- Email Section -->
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="email" class="form-control" value="{{ $edit->email }}""
                                    required placeholder="Please enter User email">
                            </div>
                        </div> <!-- / Email Section -->
                        <!-- Password Section -->
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="password" name="password" class="form-control"
                                    placeholder="Confirm edit will set User password to default" disabled required>
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="phone" class="form-control" value="" required
                                    placeholder="Confirm edit will set User phone number to default" disabled>
                            </div>
                        </div><!-- / Phone Section -->
