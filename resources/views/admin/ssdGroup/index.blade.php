                        ...
                        @foreach ($ssdGroups as $item)
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    ...
                                    <a class="btn btn-outline-info btn-sm" href="{{ Route('admin.ssdGroup.edit', $item->id) }}">
...
@section('myJs')
    <script>
        $(function() {
            $("#ssdGroupsMgmt").DataTable({
                "responsive": true,
                "lengthChange": true,
                "autoWidth": true,
                "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
            }).buttons().container().appendTo('#ssdGroupsMgmt_wrapper .col-md-6:eq(0)');
        });
    </script>
@endsection
@endif
