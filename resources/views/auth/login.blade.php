        ...
        <div class="container b-container is-txl is-z200" id="b-container">
            <form class="form" id="b-form" method="post" action="{{ Route('login') }}">
                ...
                <input class="form__input" type="text" placeholder="Email" name="email" required
                    @error('email') is-invalid @enderror autofocus autocomplete="email" value="{{ old('email') }}">
                ...
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>
                            ...
                            {{ 'Wrong email or password, please check again !' }}</strong>

                    </span>
                @enderror
                <a class="form__span" href="{{ Route('password.request') }}">Forgot your password?</a>
                <h3 style="margin-top: 15px">Or sign in with</h3>
                <p style="margin-top: 20px ;">
                    <a href="{{ route('auth.google') }} " title="Sign in with your Google account">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-google" viewBox="0 0 16 16" onMouseOver="this.style.color='#4154f1'"
                    ...
                    <a href="{{ route('auth.facebook') }}" title="Sign in with your Facebook account">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-facebook" viewBox="0 0 16 16" style="margin-left: 20px"
