        ...
        <div class="container py-5">
            <div class="row mb-4">
                <div class="col-lg-5">
                    ...
                    <p class="font-italic text-muted" style="color: aliceblue">E-Project: LAPTOP STORE</p>
                </div>
            </div>

            <div class="row text-center ">
                <!-- Team item-->
                <div class="col-xl-3 col-sm-6 mb-5 set-bg" data-setbg="{{ asset('images/anh12.jpg') }}">
                ...
                <!-- Team item-->
                <div class="col-xl-3 col-sm-6 mb-5 set-bg" data-setbg="{{ asset('images/anh10.jpg') }}">
                    <div class=" rounded shadow-sm py-5 px-4"><img
                            src="https://bootstrapious.com/i/snippets/sn-about/avatar-2.png" alt="" width="100"
                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                        <h5 class="mb-0" style="color: aliceblue">Duc Binh</h5>
                        <span class="small text-uppercase text-muted" style="color: aliceblue">Student 1376110</span>
