                            ...
                            <h5 class="d-flex align-items-center mb-3"><i
                                ...
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        {{-- Đã sửa lại điều kiện nút wishList và order, only available for customer: Dự --}}
                                        @auth
                            ...
                            <div class="row gutters-sm">
                                ...
                                overflow: auto;">
                                            <h5 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2"
                                                    ...
                                                    History Interaction of {{ auth()->user()->name }}</i>
                                            </h5>
                                            <h5 class="d-flex align-items-center mb-3">
                                                <span class="material-icons text-info mr-2">
                                                    {{ count($ratingWarning) > 0 ? '' : ' Today, let review some laptops from Shop, it will make we more happy :D' }}
                                                </span>
                                            </h5>
