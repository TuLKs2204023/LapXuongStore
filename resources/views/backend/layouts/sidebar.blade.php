               ...
               with font-awesome or any other icon font library -->
                ...
                @if (auth()->user()->role != 'Admin')
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ URL::to('/info-user') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Edit my Infomation</p>
                                </a>
                            </li>
                ...
                @if (auth()->user()->role == 'Admin')
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ URL::to('/admin/cpu') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>All CPU</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ URL::to('/admin/cpu/create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create CPU</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ URL::to('/admin/cate') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>All Cate</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ URL::to('/admin/cate/create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create Cate</p>
                                </a>
                            </li>
