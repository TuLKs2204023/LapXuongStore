...
use App\Service\Cate\CateServiceInterface;
...
class HomeController extends Controller
{
   ...
   private $productService;
    ...
    public function __construct(ProductServiceInterface $productService,
                                CateServiceInterface $CateService)
    {
    ...
    {
        $featuredProduct = $this->CateService->getFeaturedProducts();
        

        return view('fe.home.index',compact('featuredProduct'));
    }
