...
// Product details
Route::get('/product/{id}', [FE_HomeController::class, 'product'])->name('product.details');
Route::get('/product/{id}',[App\Http\Controllers\FE\ShopController::class, 'show'])->name('product');
Route::post('product/{id}',[App\Http\Controllers\FE\ShopController::class, 'postComment']);
